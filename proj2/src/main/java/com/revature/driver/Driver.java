...
//		launchResults();
	...
	public static void runTest() {
		...
		files.add("C:\\project2\\Project2_Revature\\proj2\\src\\test\\java\\newTest.xml");
		runner.setTestSuites(files);
		runner.setOutputDirectory("C:\\project2\\Project2_Revature\\proj2\\src\\main\\resources\\RunnerResources");
		runner.run();
		
		System.out.println(runner.getReporters().toString());
		System.out.println("Number of test ran was " + runner.getReporters().size());
	...
	public static boolean launchHeadlessApp() {
