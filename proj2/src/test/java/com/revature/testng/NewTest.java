...
//	}
	...
	public static void clickLocationBar() {
		...
		new WebDriverWait(d, 15)
				.until(ExpectedConditions.elementToBeClickable(d.findElement(By.id("mat-expansion-panel-header-1"))));
...
//		d.findElement(By.id("mat-input-3")).sendKeys("FarAWAY");
	...
	public static void launchResults() {
		...
		d.get("C:\\Users\\Steve Loayza\\Documents\\workspace-sts-3.9.5.RELEASE\\NewProject2Version\\test-output\\emailable-report.html");
